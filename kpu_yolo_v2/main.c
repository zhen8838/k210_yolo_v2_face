...
float g_anchor[ANCHOR_NUM * 2]= {0.405941, 0.462624, 0.904897, 1.047643, 1.438774,
                                 1.516408, 2.287601, 2.172303, 3.456722, 2.712594};
...
class_lable_t class_lable[CLASS_NUMBER]= {
    // {"aeroplane", GREEN},
    {"person", GREEN},      {"bicycle", GREEN},     {"bird", GREEN},
